...
const Layout = ({ children, data }) => (
  <div>
    <Helmet
      ...
      script={[
        { src: 'https://code.jquery.com/jquery-3.2.1.slim.min.js', crossorigin: 'anonymous' },
        { src: 'https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.3/umd/popper.min.js', crossorigin: 'anonymous' },
        { src: 'https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.2/js/bootstrap.min.js', crossorigin: 'anonymous' },
      ]}
    />
    <Navbar />
    {children()}
